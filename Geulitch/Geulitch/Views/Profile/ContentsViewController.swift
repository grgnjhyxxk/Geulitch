...
extension ContentsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if isLoading {
            guard let cell = tableView.dequeueReusableCell(withIdentifier: SkeletonTableViewCell.identifier, for: indexPath) as? SkeletonTableViewCell else { return UITableViewCell() }
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: FeedTableCustomCell.identifier, for: indexPath) as? FeedTableCustomCell else { return UITableViewCell() }
...
extension ContentsViewController {
    final class ViewHolder {
        private(set) lazy var layoutView: UITableView = {
            ...
            view.register(FeedTableCustomCell.self, forCellReuseIdentifier: FeedTableCustomCell.identifier)
